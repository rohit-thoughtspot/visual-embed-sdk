...
+
image::./static/images/style-applogo.png[Default Application Logo]
...
.. Browse to your local directory and select logo image.
+
image::./static/images/style-widelogo.png[Wide application logo]
+
...
You can set the default fonts of your system by specifying either or both of the *Chart Visualization Fonts* and *Table Visualization Fonts* values.
...
+
image::./static/images/set-background-color.png[Application Background Color]
